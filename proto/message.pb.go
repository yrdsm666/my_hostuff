...
func (x *Msg) GetCoinShare() *CoinShare {
	if x, ok := x.GetPayload().(*Msg_CoinShare); ok {
		return x.CoinShare
	}
	return nil
}

func (x *Msg) GetSpbFinal() *SpbFinal {
	if x, ok := x.GetPayload().(*Msg_SpbFinal); ok {
		return x.SpbFinal
	}
	return nil
}

func (x *Msg) GetDone() *Done {
	if x, ok := x.GetPayload().(*Msg_Done); ok {
		return x.Done
	}
	return nil
}

func (x *Msg) GetHalt() *Halt {
	if x, ok := x.GetPayload().(*Msg_Halt); ok {
		return x.Halt
	}
	return nil
}

func (x *Msg) GetPreVote() *PreVote {
	if x, ok := x.GetPayload().(*Msg_PreVote); ok {
		return x.PreVote
	}
	return nil
}
...
func (x *Msg) GetVote() *Vote {
	if x, ok := x.GetPayload().(*Msg_Vote); ok {
		return x.Vote
	}
	return nil
}
...
type Msg_CoinShare struct {
	CoinShare *CoinShare `protobuf:"bytes,14,opt,name=coinShare,proto3,oneof"`
}

type Msg_SpbFinal struct {
	SpbFinal *SpbFinal `protobuf:"bytes,15,opt,name=spbFinal,proto3,oneof"`
}

type Msg_Done struct {
	Done *Done `protobuf:"bytes,16,opt,name=done,proto3,oneof"`
}

type Msg_Halt struct {
	Halt *Halt `protobuf:"bytes,17,opt,name=halt,proto3,oneof"`
}

type Msg_PreVote struct {
	PreVote *PreVote `protobuf:"bytes,18,opt,name=preVote,proto3,oneof"`
}

type Msg_Vote struct {
	Vote *Vote `protobuf:"bytes,19,opt,name=vote,proto3,oneof"`
}
...
func (*Msg_CoinShare) isMsg_Payload() {}

func (*Msg_SpbFinal) isMsg_Payload() {}

func (*Msg_Done) isMsg_Payload() {}

func (*Msg_Halt) isMsg_Payload() {}

func (*Msg_PreVote) isMsg_Payload() {}
...
type PbValue struct {
	...
	InvokePhase string `protobuf:"bytes,4,opt,name=invokePhase,proto3" json:"invokePhase,omitempty"`
...
func (x *PbValue) GetRound() uint64 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *PbValue) GetInvokePhase() string {
	if x != nil {
		return x.InvokePhase
	}
	return ""
}
...
type PbEcho struct {
	...
	InvokePhase string `protobuf:"bytes,4,opt,name=invokePhase,proto3" json:"invokePhase,omitempty"`
	Proposal    []byte `protobuf:"bytes,5,opt,name=proposal,proto3" json:"proposal,omitempty"`
	PartialSig  []byte `protobuf:"bytes,6,opt,name=partialSig,proto3" json:"partialSig,omitempty"`
}
...
func (x *PbEcho) GetInvokePhase() string {
	if x != nil {
		return x.InvokePhase
	}
	return ""
...
func (x *PbEcho) GetPartialSig() []byte {
	if x != nil {
		return x.PartialSig
	}
	return nil
...
func (x *PbFinal) GetRound() uint64 {
	if x != nil {
		return x.Round
	}
	return 0
...
type CoinShare struct {
	...
	Round      uint64 `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Sid        uint64 `protobuf:"varint,3,opt,name=sid,proto3" json:"sid,omitempty"`
	PartialSig []byte `protobuf:"bytes,4,opt,name=partialSig,proto3" json:"partialSig,omitempty"`
}

func (x *CoinShare) Reset() {
	*x = CoinShare{}
	if protoimpl.UnsafeEnabled {
...
func (x *CoinShare) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CoinShare) ProtoMessage() {}

func (x *CoinShare) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CoinShare.ProtoReflect.Descriptor instead.
func (*CoinShare) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{15}
}

func (x *CoinShare) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CoinShare) GetRound() uint64 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *CoinShare) GetSid() uint64 {
	if x != nil {
		return x.Sid
	}
	return 0
...
func (x *CoinShare) GetPartialSig() []byte {
	if x != nil {
		return x.PartialSig
	}
	return nil
...
func (x *SpbFinal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpbFinal) ProtoMessage() {}

func (x *SpbFinal) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpbFinal.ProtoReflect.Descriptor instead.
func (*SpbFinal) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{16}
}

func (x *SpbFinal) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *SpbFinal) GetRound() uint64 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *SpbFinal) GetProposal() []byte {
	if x != nil {
		return x.Proposal
	}
	return nil
...
func (x *SpbFinal) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
type Halt struct {
	...
	Round uint64 `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Sid   uint64 `protobuf:"varint,3,opt,name=sid,proto3" json:"sid,omitempty"`
	Final []byte `protobuf:"bytes,4,opt,name=final,proto3" json:"final,omitempty"`
}
...
type PreVote struct {
	...
	Proposal   []byte `protobuf:"bytes,6,opt,name=proposal,proto3" json:"proposal,omitempty"`
	Signature  []byte `protobuf:"bytes,7,opt,name=signature,proto3" json:"signature,omitempty"`
	PartialSig []byte `protobuf:"bytes,8,opt,name=partialSig,proto3" json:"partialSig,omitempty"`
}
...
func (x *PreVote) GetRound() uint64 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *PreVote) GetLeader() uint64 {
	if x != nil {
		return x.Leader
	}
	return 0
...
func (x *PreVote) GetProposal() []byte {
	if x != nil {
		return x.Proposal
	}
	return nil
...
func (x *PreVote) GetPartialSig() []byte {
	if x != nil {
		return x.PartialSig
	}
	return nil
...
func (x *Vote) GetPartialSig() []byte {
	if x != nil {
		return x.PartialSig
	}
	return nil
...
var file_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x06, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x2a, 0x0a, 0x07,
	...
	,
	...
	0x22, 0x88, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x56, 0x6f, 0x74, 0x65,
	...
	,
	...
	0x4e, 0x75, 0x6d, 0x22, 0x8a, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x69,
	...
	,
	...
	,
	...
	0x39, 0x0a, 0x05, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75,
	...
	,
	...
	,
	...
	0x6f, 0x75, 0x6e, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	...
	,
	...
	0x10, 0x0a, 0x03, 0x73, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x73, 0x69,
	0x64, 0x22, 0x54, 0x0a, 0x04, 0x48, 0x61, 0x6c, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x6f, 0x75,
	0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x12,
	0x10, 0x0a, 0x03, 0x73, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x73, 0x69,
	0x64, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x05, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x22, 0xc7, 0x01, 0x0a, 0x07, 0x50, 0x72, 0x65, 0x56,
	...
	,
	...
	,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*CoinShare)(nil),     // 15: proto.CoinShare
	(*SpbFinal)(nil),      // 16: proto.SpbFinal
	(*Done)(nil),          // 17: proto.Done
	(*Halt)(nil),          // 18: proto.Halt
	(*PreVote)(nil),       // 19: proto.PreVote
	(*Vote)(nil),          // 20: proto.Vote
	(*Block)(nil),         // 21: proto.Block
	(*QuorumCert)(nil),    // 22: proto.QuorumCert
}
var file_message_proto_depIdxs = []int32{
	...
	15, // 13: proto.Msg.coinShare:type_name -> proto.CoinShare
	16, // 14: proto.Msg.spbFinal:type_name -> proto.SpbFinal
	17, // 15: proto.Msg.done:type_name -> proto.Done
	18, // 16: proto.Msg.halt:type_name -> proto.Halt
	19, // 17: proto.Msg.preVote:type_name -> proto.PreVote
	20, // 18: proto.Msg.vote:type_name -> proto.Vote
	21, // 19: proto.Prepare.curProposal:type_name -> proto.Block
	22, // 20: proto.Prepare.highQC:type_name -> proto.QuorumCert
	22, // 21: proto.PrepareVote.qc:type_name -> proto.QuorumCert
	22, // 22: proto.PreCommit.prepareQC:type_name -> proto.QuorumCert
	22, // 23: proto.PreCommitVote.qc:type_name -> proto.QuorumCert
	22, // 24: proto.Commit.preCommitQC:type_name -> proto.QuorumCert
	22, // 25: proto.CommitVote.qc:type_name -> proto.QuorumCert
	22, // 26: proto.Decide.commitQC:type_name -> proto.QuorumCert
	22, // 27: proto.NewView.prepareQC:type_name -> proto.QuorumCert
	0,  // 28: proto.HotStuffService.SendMsg:input_type -> proto.Msg
	0,  // 29: proto.HotStuffService.SendRequest:input_type -> proto.Msg
	0,  // 30: proto.HotStuffService.SendReply:input_type -> proto.Msg
	1,  // 31: proto.HotStuffService.SendMsg:output_type -> proto.Empty
	1,  // 32: proto.HotStuffService.SendRequest:output_type -> proto.Empty
	1,  // 33: proto.HotStuffService.SendReply:output_type -> proto.Empty
